...
namespace _110_1Mid {
    public partial class Sample2 : System.Web.UI.Page 
    {
        ...
        protected void rb_Des_SelectIndexChanged(object sender, EventArgs e) 
        {
        ...
        protected void ddl_Type_SelectIndexChanged(object sender, EventArgs e)
        {
            mt_Control(true);
        }

        protected void ddl_ZoneCode_SelectIndexChanged(object sender, EventArgs e)
        {
            mt_Control(true);
        }
